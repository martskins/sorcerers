...
- **Card metadata source:**
  - Check `Sorcery Contested Realm Product Tracker - Beta.csv` in the repo root before coding a Beta card. Use the row for the card name to confirm cost, thresholds, type, subtype, rarity, and Curiosa slug.
- **Effects:**
