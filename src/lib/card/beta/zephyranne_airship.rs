...
impl Card for ZephyryanneAirship {
...
static CONSTRUCTOR: (&'static str, CardConstructor) = (ZephyryanneAirship::NAME, |owner_id: PlayerId| {
    Box::new(ZephyryanneAirship::new(owner_id))
});
