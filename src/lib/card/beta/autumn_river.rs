...
impl ResourceProvider for AutumnRiver {}

#[async_trait::async_trait]
impl Card for AutumnRiver {
...
static CONSTRUCTOR: (&'static str, CardConstructor) = (AutumnRiver::NAME, |owner_id: PlayerId| {
