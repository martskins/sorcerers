...
impl Card for TragedyWorrywart {
...
static CONSTRUCTOR: (&'static str, CardConstructor) = (TragedyWorrywart::NAME, |owner_id: PlayerId| {
    Box::new(TragedyWorrywart::new(owner_id))
});
