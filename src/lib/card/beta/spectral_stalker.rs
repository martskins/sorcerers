...
#[derive(Debug, Clone)]
pub struct SpectralStalker {
    unit_base: UnitBase,
    card_base: CardBase,
}

impl SpectralStalker {
    pub const NAME: &'static str = "Spectral Stalker";
...
static CONSTRUCTOR: (&'static str, CardConstructor) =
    (SpectralStalker::NAME, |owner_id: PlayerId| {
