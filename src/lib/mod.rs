...
pub(crate) mod prelude {
    ...
    pub use crate::game::{
        ...
        get_knight_move_locations, pick_card, pick_card_source, pick_card_with_options,
        pick_card_with_preview, pick_cards, pick_direction, pick_location, pick_location_near,
        pick_location_near_source, pick_location_source, pick_option, pick_zone_group,
