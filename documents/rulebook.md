...
Contested Realm
The  goal  of  this  rulebook  is  to  get  you  up  to  speed  and  ready  to  play  your  first  games  of
www.sorcerytcg.com/how-to-play

. For new players, carry on from here, have someone guide you through a game, or visit
 where you’ll find tutorial videos and more. For experienced players,
...
The game uses terms and keywords that are important to know. When these come up, they have been
 to not only help you identify important words and concepts, but to also tell you that you can find
...
realm
 ...
 as a powerful Avatar. You will have a
In a game of
...
dominion. In order to win, you must defeat any opposing Avatar by first reducing their
placing them at
, and then delivering a final
Decks
the enemy’s connection to the realm and grants you victory!

 with one goal: to vanquish their opponents and claim sole
 total to zero,
 to the weakened Avatar. This severs
...
26). The world of
 ...
 grants you endless possibilities!
...
Sorcery: Contested Realm
 ...
 is built around the four classical elements: Air, Earth, Fire, and Water. Most
...
Air  is  the  element  of
  dabbling  in  forces  beyond  mortal  control  to
...
Earth is the element of
 defined by its focus on fielding and enhancing
...
willing to do whatever it takes to secure victory
...
Water is the element of
ready to adapt and disrupt the strategies of the
...
In
, your cards are what allow you to influence the realm and do battle with
...
, which you will harness

.

•  Sites have a name
•  Sites  have  a  typeline
  that
describes  key  things  about  that
card, such as rarity.
•  Most sites have elemental symbols that increase your elemental affinity
to use spells and abilities (see page 18).
•  Sites have a game text box
•  Sites will provide you with
abilities during your turn (see page 17).
•  Sites have two levels:

 that describes their special abilities.
...
, an important resource that you will need to play cards and use

void
When a site is destroyed it is placed in its owner’s cemetery as normal, but rather than creating a new
 site that no player controls, and

, the site is instead replaced with rubble. Rubble is a neutral
...
to be played.
•  Minions have a power rating
 that reflects
damage
how hard they hit in combat. It also describes
 they can take before dying.
how much
If  the  minion  receives  damage  equal  to  or
greater than that value, it
•  Minions  have  a  type  line
  that  describes
key  things  about  that  card,  such  as  subtypes
and rarity.
•  Minions  have  a  game  text  box
describes their special abilities.
...
cards while in the
. The major difference between cards and tokens
is that tokens are never part of a player’s deck, and they can never formally
.  If  a  token  would  be  placed
exist  in  any  zone  except  within  the
...
•  Each  artifact  has  a
must pay to play it.
•  Artifacts  have  a  type  line
  that  describes
key  things  about  that  card,  such  as  subtypes
and rarity.
•  Artifacts  have  a  game  text  box
describes their special abilities.
...
Note:
 ...
 Unlike other spells, artifacts do not typically
...
order to be played.
•  Auras have a type line
things about that card, such as rarity.
•  Auras  have  a  game  text  box
describes their special abilities.
...
order to be played.
•  Magics have a type line
things about that card, such as rarity.
•  Magics  have  a  game  text  box
describes their special abilities.
...
,  players  share  the  main  and  biggest  part  of  the  play  area—the

.

The realm
 is a 5x4 square grid where most cards
void
are played. These twenty squares begin as pieces
of the
 that you and your opponent may fill in
with sites as you expand your domains.
Atlas and Spellbook

Each player has two decks of cards—an atlas of at
, containing maps to domains
least 30 site cards
waiting  to  be  explored,  and  a  spellbook  of  at
least 60 spell cards
, filled with all of a player’s
...
are kept in your hand
. Your hand should remain
...
Now that you’re familiar with the components, follow these steps to set up a two-player game of
...
Players place their Avatars on the
...
order to do this, you’ll need to get them to
...
, from either taking damage directly or their sites being attacked, its connection
 and can
. At that moment, the wounded Avatar becomes immune to damage for the rest of

As an Avatar loses
life
with the
 weakens. When an Avatar’s
no longer gain
that turn.
After that brief and desperate window, any damage dealt to the Avatar is a
their connection to the realm and signaling their defeat.

 is reduced to 0, they are now at
...
Areas of the Realm
 ...
 battles are often won or lost in the way you position and maneuver your
...
opponent may fill in with sites as you expand your domains.
 ...
 is split into twenty squares. These squares begin as pieces of the
...
The void is a
 of incorporeal nothingness on top of which you will build your physical domain.
banished
Any  minion  that  somehow  finds  its  way  into  the  void  (whether  in  whole  or  in  part)  is  immediately
Voidwalk
 (removed from the game) unless it has an ability that specifically allows it to exist there (such
...
Sites can be separated into two main types.
Groups of Water & Land
with
 ). All other sites are considered

land sites

 are identified by the water threshold icon (marked

rubble

, including sites with no threshold icons and
...
though the Aqueduct has a
, so it is a water site.
has a
...
as the
 ...
 and its lower one is the

region

The upper level of all sites form a
The Subsurface
and wage war on the enemy. All units above a site are considered to be on the surface.

 known as the surface. This is where units will typically move

site
The subsurface is divided into two
region
...
, depending on what type of site it is. The lower level of a

. Similarly, the lower level of a

, is part of the

. Existing in the subsurface is extremely hazardous and minions that somehow find their way there

Atop and Under
immediately

, unless otherwise allowed to do so with special abilities (see page 38).

atop

under
When cards enter a site’s surface level, place it

atop

 the site to show that it occupies the subsurface.

under

 the site to show that it is on the surface, or slide it

If  a  card  refers  to  something
anything below it. Similarly, if a card refers to something
Regions
subsurface of the site, but not anything above it.

  a  site,  it  applies  to  something  on  the  surface  of  the  site,  but  not
 a site, it applies to something in the
...
A
 ...
 is defined as one region in one square.

“Here” and “There” are used to contextually refer to the
such as avatars, minions, and artifacts, that means one
Targeting
they occupy. For sites, it means two

locations

, their surface and subsurface.

(s) that a card occupies. For most cards,
. For most auras, it means the 2x2 area
...
the
 ...
 or referencing card’s same region.

Sometimes a card will need to identify something in an
...
nearby
 ...
 Refers to the card’s own square, and the squares that it shares a border with.
  ...
  Refers  to  the  card’s  own  square,  and  all  squares  that  surround  it,  including  those
...
adjacent or nearby
 ...
 as the referencing card (or its
...
In this example, the King of the Realm
...
The King is not adjacent to the Headless Haunt
 ...
 is not nearby the King because it is

 are not adjacent to the King
...
A step is the minimum unit of distance between two
. Some card abilities will have
...
is played over a series of turns. Players take their turns, one at a time, following
...
Step 2.  All of your sites now provide their
Step 3.  Trigger abilities that happen at the start of the turn.
Step 4.  Finally, draw a card from either your spellbook
...
The main phase is where most of
can be ordered to do two types of actions. They can:
•  Cast a spell from your hand if they are a
•  Activate one of their abilities (see page 20)

 (see page 17) or,

’s actions and events take place. During this phase, your units
...
this, you must use your Avatar’s ability to play a site to your Avatar’s
...
Spells are the main way Avatars and other
. Any card in your hand that is
not a site is a spell. You cast these spells to summon minions, conjure artifacts or auras, and invoke magics.
Spellcaster
  under  your  control  to  cast  it.  The
To  cast  a  spell  from  your  hand,  you  need  to  identify  a
elemental threshold
Spellcaster
 are by whom and where the spell is being cast. Once you have identified the
...
Mana
 ...
 and its
, spells often have two requirements to play: a
Spellcasters
...
You can only gain mana during your turn and lose any unspent mana at the end of your turn.
 ...
 use mana to cast their spells and some abilities may also draw from this power.
...
. Playing Maelström would bring your total
ability
...
mana
 ...
 for earth) next to the

In  addition  to
some abilities. Spells and some abilities will have one or more elemental symbols (

,  you  will  often  need  to  meet  an  elemental  threshold  to  cast  most  spells  or  use
 for air,
 cost on spells, or to the left of abilities in text boxes.
...
Elemental  threshold  is  not  spent  like
.  It  is  simply  a  minimum  affinity  you  must  have  for  the
...
only require a threshold of two
affinity of three
...
and they remain in the
 until something causes them to leave play.
...
When an artifact spell is cast, it is conjured into the
Casting Auras
waiting hands of one of your units. A unit can carry any number of artifacts.

 atop any site you control or directly into the

squares

squares

When an aura spell is cast, it conjures the aura at the intersection of four
the border between two, or even just a single
Casting Magics
, as well as any
those
...
, affecting them (or other things located at those sites) in some way.
...
. A magic spell simply does what it says it does, and then goes to its owner’s cemetery.
presence in the
...
intention to do so, making any relevant choices (like picking targets), and paying any associated costs.
 costs most often, abilities will use a variety of costs including things like
Unlike spells, which use
tapping, paying
, sacrificing a minion, or discarding cards, among other things. Only the controller
...
•  on
•  adjacent to another site that you control
no sites.
...
, and
 ...
 or as close as possible to your Avatar if you control
void
...
There can only be one site per grid
permanently  extending  the  physical  boundaries  of  your  domain  within  the
played on

, which means sites are generally placed on an adjacent
...
. By default, units can move one
When moving a unit, its journey is broken down into individual
step.  However,  some  abilities  allow  units  to  take  additional  steps  (such  as  Movement  +X)  and  other
abilities allow units to take steps diagonally or even into different
...
strikes
 each other simultaneously. When a unit
, units
page 24), the units involved will
...
Zero damage is not any damage at all, so units with 0 power must take at least 1 damage to die.
...
the Nomads suffer five damage

, well exceeding its power of two and so it immediately dies .
...
damaging it and causing the controlling Avatar to lose that much life. Importantly, attacking a site cannot
 because it causes the controlling Avatar to lose life, not take damage directly. You
deliver a
...
Airborne,
moving to the attack’s location and joining the
. Any number of units may defend against an attacker.
Voidwalk
Burrowing
During  this  movement  a  defending  unit  may  use  any  of  its  movement  abilities,  such  as
...
, or is removed. If the original target was a site, it is automatically removed.
...
and move it to the location of the Rimland Nomads
...
any of your units there may tap to intercept and
...
Sorcery: Contested Realm
 ...
 is a customizable trading card game, which means that you can choose what
...
.  This  tells  you  how  many  copies  of  that
rarity
...
Keyword Ability
 ...
 have one or more special abilities printed in their game text box that change the
...
,  but  some  cards  have  abilities  that
the
...
costs,  such  as  tapping  or  spending
.  By
...
occupy, the unit ceases to be carried.
 ...
 confer those abilities to units they are carrying while
...
card’s effect, or a dot to show the
 on the grid.
locations
By default, a damage grid indicates that the ability deals damage to
region
each unit at
 within the area of effect and within the same
Occupying Multiple Sites

, though cards may specify otherwise.
...
Units  normally  occupy  only  one  location  while  in  the
,
...
void squares) at the same time. Therefore, if grid damage is dealt to
 equal to the
multiple such locations, oversized units take
sum of the
...
When attacking, oversized units still target only a single enemy or site.
 ...
 dealt on all of the locations they occupy.

damage

damage

When an oversized unit is teleported, it must be to a
...
You have ownership of all of the cards you bring to a game of
. You are, therefore, the owner
...
and travels within the same
.
Its  flight  continues  until  it  either  reaches  the  edge  of  its
)  along  its
region  or  it  reaches  the  first  unit  (
...
. Each of the three projectiles travel in the chosen cardinal direction, starting at
Arn Bannerman
the Salamander’s location and travelling over the Arid Desert, avoiding the  burrowed Cave Trolls,
. When they arrive at the Rustic Village, you can have the first
which are not in the same region
. Unfortunately, the third
two projectiles hit the Bannerman, which suffers two damage and dies
projectile then hits your own Seasoned Sellsword
...
Sorcery
 ...
 starts to get complicated, particularly when multiple

When the story being told during a game of
...
event is added
, temporarily interrupting any remaining events on the Storyline.
...
Ghost Ship Move & AttackGhost Ship moves: void 13 to surface 12Glossary of Terms and Keywords
...
Broken
A contiguous cluster of adjacent
...
disabled
  ...
  while  not  occupying  a
.  For  example,  a  minion
 while not occupying
...
.  When  taking
land site
,  it  can  instead  move  from  the  surface  of  a
a
 level there, or vice
...
life
 ...
 is reduced to 0, they are now
When an Avatar’s
at death’s door and can no longer gain
. At that
...
, do what is stated before placing
...
door
Avatar  can  endure  before  it  is  placed  on

. As your Avatar incurs damage, its overall life
...
cardinal direction
location  and  travels  within  the  same
  in  a
. Its flight continues until it either
ally
reaches the edge of its region or it reaches the first
unit  (
)  along  its  path,  ignoring  any
...
abilities.  To  move  multiple
  at  once,  choose
a  destination  and  a  path  to  it  then  traverse  that
 at a time. You may need to resolve
path one
...
replaced with rubble. Rubble is a neutral
 site
...
Sacrificing  is  removing  something  you  control
  and  placing  it  directly  in  its
from  the
...
A
  unit  cannot  be  sacrificed.  When  a  site
indestructible
is  sacrificed,  it  is  replaced  by  rubble.  Even
  things  can  be  sacrificed,  if  a  cost
...
region
 ...
 without a site is a part of the void
A
banished
Avatars  can  never  enter  void
Voidwalk
there are
...
Untap all of your cards in the realm.
 All of your sites provide their mana.

Trigger  abilities  that  happen  at  the

Step 4:
start of the turn.

End the Start Phase by drawing a card
...
Step 1:
 ...
 Trigger abilities that happen at the end

Step 2:
of the turn.

 Players remove all damage from their

Step 3:
minions in the realm.
Step 4:

 Effects that last for your turn now end.
Your turn ends.
...
Regions:
 ...
 Surface, Underground, Underwater, and

Location:
the Void are all separate regions in the game.

  The  exact  location  of  a  card  is
that

determined by its square and by the region
it occupies.
...
same region.
  ...
  Refers  to  the  card’s  own  square  and
...
or nearby locations.
  ...
  A  step  is  the  minimum  unit  of  distance
...
using the Move and Attack  or Defend abilities. To
 at once, choose a destination
move multiple
and a path to it then traverse that path one
 at
...
underground
 to
, it can move from the surface of a
...
step
This unit can be safely summoned to, exist in, and
operate normally underwater. When taking a
,
underwater
 to the
it can move from the surface of a
